        ...
        <section className="bg-white py-16">
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                                ...
                                <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                        ...
                                        <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                            ...
                                            <a href="#" className='flex items-center justify-center gap-2 hover:bg-red-500 px-4 py-1 rounded-es-md duration-300'>
                    ...
                    <button
                        onClick={scrollPrev}
                        className="bg-white flex items-center justify-center rounded-full shadow-lg p-2 absolute left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
                    >
                    ...
                    <button
                        onClick={scrollNext}
                        className="bg-white flex items-center justify-center rounded-full shadow-lg p-2 absolute -right-6 -translate-x-1/2 -translate-y-1/2 top-1/2 z-10"
                    >
                        <ChevronRight />
                    </button>
